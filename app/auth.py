...
# Speichere die Datenbank im temp-Ordner (funktioniert auf Render)
DB_FILE = os.path.join(tempfile.gettempdir(), "users.json")
...
def load_db():
    ...
    try:
        ...
        # Falls Datei korrupt ist, neu initialisieren
        init_db()
        with open(DB_FILE, 'r') as f:
            return json.load(f)
